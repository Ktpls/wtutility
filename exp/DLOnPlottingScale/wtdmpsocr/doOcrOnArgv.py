...
filelist=[row[0] for row in Xls2ListList(r"C:\file\code\wtutility\exp\DLOnPlottingScale\dataset\plottingscaleorgDataset\appendix.xlsx") if row[0] is not None]
