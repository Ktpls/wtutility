...
src = r"C:\prog\wtutility\exp\DLOnPlottingScale\dataset\charDataset\labeled"
dst = r"C:\prog\wtutility\exp\DLOnPlottingScale\dataset\charDataset\dedued"
i = 0
while i <= 10:
    try:
...
for root, dirs, files in os.walk(src):
    ...
    dedued = deduplicate_images(files, 2)
